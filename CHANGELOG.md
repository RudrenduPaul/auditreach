...
- Enabled branch protection on `main`: pull request + 1 approving review + a passing `ci` status check required before merge, no force-pushes, no branch deletion. See `docs/branch-protection.md`.
